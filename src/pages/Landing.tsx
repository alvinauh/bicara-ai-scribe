            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <div className="h-6 w-6 rounded-full bg-bicaraBlue-100 flex items-center justify-center">
                    <span className="text-bicaraBlue-600 text-sm">✓</span>
                  </div>
                  <p className="text-gray-700">Multilingual Support (English, BM, Mandarin)</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="h-6 w-6 rounded-full bg-bicaraBlue-100 flex items-center justify-center">
                    <span className="text-bicaraBlue-600 text-sm">✓</span>
                  </div>
                  <p className="text-gray-700">Convert Notes to Presentations & Essays</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="h-6 w-6 rounded-full bg-bicaraBlue-100 flex items-center justify-center">
                    <span className="text-bicaraBlue-600 text-sm">✓</span>
                  </div>
                  <p className="text-gray-700">Google Drive Integration</p>
                </div>
              </div>
            </div>
